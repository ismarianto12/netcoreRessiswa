        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NamaKelas = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.InsertData(
                table: "siswa",
                columns: new[] { "Id", "Alamat", "Kelas", "Nama", "NoTelp" },
                values: new object[,]
                {
                    { 1, "Padang", "XII IPA 1", "Ismarianto", "081234567890" },
                    { 2, "Jakarta", "XII IPS 2", "Amalya", "089876543210" }
                });
        }
